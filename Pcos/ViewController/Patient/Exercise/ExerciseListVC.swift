...
class ExerciseListVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    var thursday = ["Burpees", "Mountain Climber","Pendulum Swings","Mountain Climber (again)","Side Lunges","Quick Feet", "Butt Kicks"," Skipping without Rope", "Side Hop", "Squat Pulses","  Straight Leg Fire Hydrant (Left)","Straight Leg Fire Hydrant (Right)","Glute Kick Back (Left)"," Glute Kick Back (Right)", "Fast Spider Lunges","Side Leg Circuits (Left)", "Side Leg Circuits (Right)", "Bottom Leg Lift (Left)","Bottom Leg Lift (Right)","Reclined Oblique Swings"]
    var friday = ["Plie Squats","Walking Squats","Burpees","Mountain Climber","Pendulum Swings","Mountain Climber (again)","Flutter Kicks","Side Lunges,Backward Lunge","Crab Kicks,Skipping without Rope,Side Hop,Quick Feet,Butt Kicks,Squat Pulses,Straight Leg Fire Hydrant (Left)","Straight Leg Fire Hydrant (Right)","Glute Kick Back (Left)","Glute Kick Back (Right)","Fast Spider Lunges"]
